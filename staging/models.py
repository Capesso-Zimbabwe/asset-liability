...
class OverdraftContract(models.Model):
    ...
    v_day_count_ind= models.CharField(max_length=7,null=True,default='30/365', help_text="This column stores the accrual basis code for interest accrual calculation.")
    ...
    v_instrument_type_cd = models.CharField(max_length=50,null=True, default="")
...
class LoanPaymentSchedule(models.Model):
    ...
    n_rate = models.DecimalField(max_digits=7, decimal_places=2)
...
class Investment(models.Model):
    ...
    n_interest_freq = models.IntegerField(null=True, blank=True)
    v_interest_freq_unit = models.CharField(max_length=50, null=True)
    v_day_count_ind= models.CharField(max_length=7,default='30/365',null=True, help_text="This column stores the accrual basis code for interest accrual calculation.")
    v_ccy_code = models.CharField(max_length=10, null=True)
    n_curr_payment_recd= models.DecimalField(max_digits=10, decimal_places=2, null=True)
    v_instrument_type_cd = models.CharField(max_length=50, default="", null=True)
...
class CreditLine(models.Model):
    ...
    v_ccy_code = models.CharField(max_length=10, null=True)
    v_interest_rate = models.DecimalField(max_digits=7, decimal_places=5)
    v_amrt_freq = models.CharField(max_length=1, null=True)
